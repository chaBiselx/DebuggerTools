...
namespace Test\Fonctionnal\Trace;
...
use Test\ObjectForTest\Entity\TraceEntity;
...
class BaseTraceTest extends BaseTestCase
{
    ...
    {
        self::staticValue();
        $this->assertMatchesRegularExpression('/tests\/Fonctionnal\/Trace\/BaseTraceTest\.php \(line : \d+\)  \'Test\\\\Fonctionnal\\\\Trace\\\\BaseTraceTest\'\s*\n\s*:: staticValue\(\)/', $this->getContent());
    }
    ...
    public function testClosureFunction()
    {
        ...
        $closure();
        $this->assertMatchesRegularExpression('/tests\/Fonctionnal\/Trace\/BaseTraceTest\.php \(line : \d+\)  \'Test\\\\Fonctionnal\\\\Trace\\\\BaseTraceTest\'\s*\n\s*-> Test\\\\Fonctionnal\\\\Trace\\\\\{closure\}\(\)/', $this->getContent());
    }
    ...
    public function testtraceParamObject()
    {
        ...
        $this->assertMatchesRegularExpression('/tests\/Fonctionnal\/Trace\/BaseTraceTest\.php \(line : \d+\)  \'Test\\\\Fonctionnal\\\\Trace\\\\BaseTraceTest\'\s*\n\s*-> traceParamObject\(\'Test\\\\ObjectForTest\\\\Entity\\\\UserEntity\'\)/', $this->getContent());
    }
    ...
    public function testTraceInObjectPublic()
    {
        ...
        $this->assertMatchesRegularExpression('/tests\/Fonctionnal\/Trace\/BaseTraceTest\.php \(line : \d+\)  \'Test\\\\ObjectForTest\\\\Entity\\\\TraceEntity\'\s*\n\s*-> traceInPublic\(\)/', $this->getContent());
    }
    ...
    public function testTraceInObjectPrivate()
    {
        ...
        $this->assertMatchesRegularExpression('/tests\/ObjectForTest\/Entity\/TraceEntity\.php \(line : \d+\)  \'Test\\\\ObjectForTest\\\\Entity\\\\TraceEntity\'\s*\n\s*-> functionPrivate\(\)/', $this->getContent());
    ...
    public function testTraceInObjectClosure()
    {
        ...
        $this->assertMatchesRegularExpression('/tests\/ObjectForTest\/Entity\/TraceEntity\.php \(line : \d+\)  \'Test\\\\ObjectForTest\\\\Entity\\\\TraceEntity\'\s*\n\s*-> Test\\\\ObjectForTest\\\\Entity\\\\\{closure\}\(\)/', $this->getContent());
