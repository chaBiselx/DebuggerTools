...
class SimpleTypeTest extends BaseTestCase
{
    ...
    public function testObject()
    {
        ...
        $this->assertMatchesRegularExpression('/class \'Test\\\\ObjectForTest\\\\Entity\\\\UserEntity\' : {"lastName":"Doe","firstName":"John","->getRole":null,"->getId":\d*,"->getLastName":"Doe","->getFirstName":"John"}(\s*)$/', $this->getContent());
    }
