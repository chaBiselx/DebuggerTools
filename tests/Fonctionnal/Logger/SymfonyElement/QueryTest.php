...
class QueryTest extends SymfonyTestCase
{
    ...
    {
        $query = self::$entityManager->createQuery('SELECT re.roleName FROM Test\ObjectForTest\Entity\RoleEntity re');
    ...
    {
        $query = self::$entityManager->createQuery('SELECT re.roleName FROM Test\ObjectForTest\Entity\RoleEntity re WHERE re.roleName = :roleName');
    ...
    {
        $query = self::$entityManager->createQuery('SELECT re.roleName FROM Test\ObjectForTest\Entity\RoleEntity re WHERE re.id = :roleId');
    ...
    public function testSelectSimpleWithParamObject()
    {
        ...
        $query = self::$entityManager->createQuery('SELECT re.roleName FROM Test\ObjectForTest\Entity\RoleEntity re WHERE re.id = :RoleEntity');
