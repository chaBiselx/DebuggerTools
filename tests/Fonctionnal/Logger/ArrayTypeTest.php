...
class ArrayTypeTest extends BaseTestCase
{
    ...
    public function testArrayObject()
    {
        ...
        $this->assertMatchesRegularExpression('/array : \[{"class":"Test\\\ObjectForTest\\\Entity\\\\UserEntity","content":{"lastName":"Doe","firstName":"John","->getRole":null,"->getId":\d*,"->getLastName":"Doe","->getFirstName":"John"}}\](\s*)$/', $this->getContent());
    }
